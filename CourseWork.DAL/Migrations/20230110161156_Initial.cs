        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgRef = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SrcId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "IsBlocked", "Name", "Password", "RegistrationDate", "Role" },
                values: new object[] { 1, false, "admin", "fb001dfcffd1c899f3297871406242f097aecf1a5342ccf3ebcd116146188e4b", new DateTime(2023, 1, 10, 21, 11, 56, 215, DateTimeKind.Local).AddTicks(5688), 1 });

			migrationBuilder.InsertData(
                table: "Profiles",
                columns: new[] { "Id", "ImgRef", "UserId" },
                values: new object[] { 1, "avatar.png", 1 });
